...
const schemaData = {
  ...
  "@graph": [
    {
      "@type": "WebSite",
      "@id": "https://clouddine.store/#website",
      "url": "https://clouddine.store/",
      "name": "CloudDine",
      ...
      "publisher": {
        "@id": "https://clouddine.store/#organization",
      },
    },
    {
      "@type": "Organization",
      ...
      "url": "https://clouddine.store/",
      "logo": "https://clouddine.store/logo.png",
      "image": "https://clouddine.store/logo.png",
    },
    {
      "@type": "SoftwareApplication",
      "@id": "https://clouddine.store/#software",
      "name": "CloudDine",
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://clouddine.store/" },
      { property: "og:site_name", content: "CloudDine" },
      { property: "og:image", content: "https://clouddine.store/logo.png" },
      ...
      { name: "twitter:image", content: "https://clouddine.store/logo.png" },
    ],
    links: [
      { rel: "canonical", href: "https://clouddine.store/" },
